...
import com.projek_tugas_akhir.arsitektur_mvvm_dan_greendao.databinding.SelectFragmentBinding;
...
public class SelectFragment extends BaseFragment<SelectFragmentBinding, CRUDViewModel> implements CRUDNavigator,
        CRUDAdapter.CRUDAdapterListener {

    @Inject
    CRUDAdapter selectAdapter;

    SelectFragmentBinding selectFragmentBinding;
...
//                viewModel.fetchMedicals();
    ...
    public void updateMedical(List<Medical> medicalList) {
        selectAdapter.addItems(medicalList);
    }
